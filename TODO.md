...
Form:
    ...
    Single Line Fields:
        ...
        2. Phone No. (Required)
        3. Email (Required)
        4. Instagram Handle (Required)

    Dual Button Questions (Required):
...
1. Know your mentor (URL(button))
2. Submit Form (Send Details to google sheet using appscript on the sheet side)
